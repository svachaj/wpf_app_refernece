...
{
    public partial class ShiftsTypeDetailViewModel : ValidationViewModelBase
    {
        public ShiftsTypeDetailViewModel()
            : base()
        {

        }

        private ShiftType _selectedItem = null;

        public ShiftType SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.ShiftTypes.AddObject(SelectedItem);
                    }
                    else
                    {
