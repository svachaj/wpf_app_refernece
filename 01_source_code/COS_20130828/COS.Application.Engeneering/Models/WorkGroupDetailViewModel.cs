...
{
    public partial class WorkGroupDetailViewModel : ValidationViewModelBase
    {
        public WorkGroupDetailViewModel()
            : base()
        {
           
        }

        private WorkGroup _selectedItem = null;
        public WorkGroup SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.WorkGroups.AddObject(SelectedItem);
                    }
                    else
                    {
