...
{
    public partial class ItemsGroupDetailViewModel : ValidationViewModelBase
    {
        public ItemsGroupDetailViewModel()
            : base()
        {

        }

        private ItemGroup _selectedItem = null;

        public ItemGroup SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.ItemGroups.AddObject(SelectedItem);
                    }
                    else
                    {
