...
{
    public partial class ShiftPatternsDetailViewModel : ValidationViewModelBase
    {
        public ShiftPatternsDetailViewModel()
            : base()
        {

        }

        private ShiftPattern _selectedItem = null;

        public ShiftPattern SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.ShiftPatterns.AddObject(SelectedItem);
                    }
                    else
                    {
