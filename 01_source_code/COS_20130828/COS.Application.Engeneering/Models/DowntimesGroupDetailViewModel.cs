...
{
    public partial class DowntimesGroupDetailViewModel : ValidationViewModelBase
    {
        public DowntimesGroupDetailViewModel()
            : base()
        {

        }

        private DowntimeGroup _selectedItem = null;

        public DowntimeGroup SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.DowntimeGroups.AddObject(SelectedItem);
                    }
                    else
                    {
