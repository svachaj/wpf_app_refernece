...
{
    public partial class DowntimesDetailViewModel : ValidationViewModelBase
    {
        public DowntimesDetailViewModel()
            : base()
        {

        }

        private Downtime _selectedItem = null;

        public Downtime SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.Downtimes.AddObject(SelectedItem);
                    }
                    else
                    {
