...
{
    public partial class cbProdPlanExecutionTypeDetailViewModel : ValidationViewModelBase
    {
        public cbProdPlanExecutionTypeDetailViewModel(COSContext dataContext)
            : base()
        {
        ...
        private ProdPlanExecutionType _selectedItem = null;
        public ProdPlanExecutionType SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        dataContext.ProdPlanExecutionTypes.AddObject(SelectedItem);
                    }
                    else
                    {
        ...
        internal ProdPlanExecutionType CreateNewItem()
        {
            ProdPlanExecutionType res = dataContext.ProdPlanExecutionTypes.CreateObject();
