...
{
    public partial class cbProdPlanTransportTypeDetailViewModel : ValidationViewModelBase
    {
        public cbProdPlanTransportTypeDetailViewModel(COSContext dataContext)
            : base()
        {
        ...
        private ProdPlanTransportType _selectedItem = null;
        public ProdPlanTransportType SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        dataContext.ProdPlanTransportTypes.AddObject(SelectedItem);
                    }
                    else
                    {
        ...
        internal ProdPlanTransportType CreateNewItem()
        {
            ProdPlanTransportType res = dataContext.ProdPlanTransportTypes.CreateObject();
