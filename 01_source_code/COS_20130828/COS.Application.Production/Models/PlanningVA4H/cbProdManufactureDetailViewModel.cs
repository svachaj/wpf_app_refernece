...
{
    public partial class cbProdManufactureDetailViewModel : ValidationViewModelBase
    {
        public cbProdManufactureDetailViewModel(COSContext dataContext)
            : base()
        {
        ...
        private ProdPlanManufacture _selectedItem = null;
        public ProdPlanManufacture SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        dataContext.ProdPlanManufactures.AddObject(SelectedItem);
                    }
                    else
                    {
        ...
        internal ProdPlanManufacture CreateNewItem()
        {
            ProdPlanManufacture res = dataContext.ProdPlanManufactures.CreateObject();
