...
{
    public partial class cbProdSupplierDetailViewModel : ValidationViewModelBase
    {
        public cbProdSupplierDetailViewModel(COSContext dataContext)
            : base()
        {
        ...
        private ProdPlanSupplier _selectedItem = null;
        public ProdPlanSupplier SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        dataContext.ProdPlanSuppliers.AddObject(SelectedItem);
                    }
                    else
                    {
        ...
        internal ProdPlanSupplier CreateNewItem()
        {
            ProdPlanSupplier res = dataContext.ProdPlanSuppliers.CreateObject();
