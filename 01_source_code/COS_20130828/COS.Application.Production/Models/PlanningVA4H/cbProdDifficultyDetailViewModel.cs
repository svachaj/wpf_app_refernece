...
{
    public partial class cbProdDifficultyDetailViewModel : ValidationViewModelBase
    {
        public cbProdDifficultyDetailViewModel(COSContext dataContext)
            : base()
        {
        ...
        private VA4H_difficultyType _selectedItem = null;
        public VA4H_difficultyType SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        dataContext.VA4H_difficultyType.AddObject(SelectedItem);
                    }
                    else
                    {
        ...
        internal VA4H_difficultyType CreateNewItem()
        {
            VA4H_difficultyType res = dataContext.VA4H_difficultyType.CreateObject();
