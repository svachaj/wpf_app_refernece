...
namespace COS.Application.Shared
{
    public partial class BonusGroup
    {
        ...
        public  const string ADSAll = "ADSAll";
        public  const string ADSPerShift = "ADSShift";
        public  const string PerEmployee = "Employee";
        public  const string PerHrWgShift = "WGShift";
    }
