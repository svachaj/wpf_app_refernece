...
{
    public partial class HrDepartmentUsersViewModel : ValidationViewModelBase
    {
        public HrDepartmentUsersViewModel()
            : base()
        {
        ...
        public List<User> ItemsToAdd
        {
            get
            {
                var ordepusers = COSContext.Current.OrderDepartmentUsers.Where(a => a.ID_department == SelectedHrDepartment.ID);
        ...
        public List<OrderDepartmentUser> SelectedItems
        {
            get
            {
                return COSContext.Current.OrderDepartmentUsers.Where(a => a.ID_department == SelectedHrDepartment.ID).OrderBy(a => a.Users.Surname).ToList();
            }
        }

        private OrderDepartmentUser _selectedItem = null;
        public OrderDepartmentUser SelectedItem
        {
            get
            {
        ...
        public void Delete()
        {
            ...
            {
                COSContext.Current.OrderDepartmentUsers.DeleteObject(SelectedItem);
        ...
        public void AddNew()
        {
            OrderDepartmentUser wgwc = new OrderDepartmentUser();

            wgwc.ID_department = SelectedHrDepartment.ID;
            wgwc.ID_user = SelectedUser.ID;

            COSContext.Current.OrderDepartmentUsers.AddObject(wgwc);
