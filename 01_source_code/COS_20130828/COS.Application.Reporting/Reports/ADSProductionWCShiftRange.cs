namespace COS.Application.Reporting.Reports
{
    ...
    /// </summary>
    public partial class ADSProductionWCShiftRange : Telerik.Reporting.Report
    {
        public ADSProductionWCShiftRange(ADSProductionWCShiftRangeModel source)
        {
            //
            ...
            //Labels
            tbHeader.Value = ResourceHelper.GetResource<string>("rep_ShiftFollowupHeader") + " - Od: " + (source.SelectedDateFrom.HasValue == true ? source.SelectedDateFrom.Value.ToShortDateString() : "") + "  Do: " + (source.SelectedDateTo.HasValue == true ? source.SelectedDateTo.Value.ToShortDateString() : "");
        ...
        public ADSProductionWCShiftRangeModel model = null;
