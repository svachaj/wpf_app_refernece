...
{
    public partial class ADSProductionDetailViewModel : ValidationViewModelBase
    {
        public ADSProductionDetailViewModel()
            : base()
        {
        ...
        public void ShowReportInternal()
        {
            ...
            if (!string.IsNullOrEmpty(SelectedItemNumber))
                productions = productions.Where(a => a.ItemNumber == SelectedItemNumber);
            ...
            Models = new List<ADSProductionDetailViewModel>();

            Models.Add(this);
        }

        public List<ADSProductionDetailViewModel> Models = null;
        ...
        private string _SelectedItemNumber = null;
