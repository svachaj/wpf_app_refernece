...
{
    public partial class ADSProductionWCShiftModel : ValidationViewModelBase
    {
        public ADSProductionWCShiftModel()
            : base()
        {
        ...
        public void GenerateData()
        {
            ...
            if (SelectedDate != null && SelectedDivision != null && SelectedShiftType != null)
            {
                ReportData.Clear();

                var prods = cc.HourlyProductions.Where(a => a.ID_Division == SelectedDivision.ID && a.ID_ShiftType == SelectedShiftType.ID && a.Date == SelectedDate);
    ...
    public class ConditionalFormatClassWCShift
    {
        public decimal Performance_More { set; get; }
        public decimal Performance_LessEq { set; get; }
        public decimal Performance_MoreEq { set; get; }
        public decimal Performance_Eq { set; get; }

        public decimal Availability_More { set; get; }
        public decimal Availability_LessEq { set; get; }
        public decimal Availability_MoreEq { set; get; }
        public decimal Availability_Eq { set; get; }

        public decimal Quality_More { set; get; }
        public decimal Quality_LessEq { set; get; }
        public decimal Quality_MoreEq { set; get; }
        public decimal Quality_Eq { set; get; }

        public decimal OEE_More { set; get; }
        public decimal OEE_LessEq { set; get; }
        public decimal OEE_MoreEq { set; get; }
        public decimal OEE_Eq { set; get; }

        public decimal Performance_More_VA { set; get; }
        public decimal Performance_LessEq_VA { set; get; }
        public decimal Performance_MoreEq_VA { set; get; }
        public decimal Performance_Eq_VA { set; get; }

        public decimal Availability_More_VA { set; get; }
        public decimal Availability_LessEq_VA { set; get; }
        public decimal Availability_MoreEq_VA { set; get; }
        public decimal Availability_Eq_VA { set; get; }

        public decimal Quality_More_VA { set; get; }
        public decimal Quality_LessEq_VA { set; get; }
        public decimal Quality_MoreEq_VA { set; get; }
        public decimal Quality_Eq_VA { set; get; }

        public decimal OEE_More_VA { set; get; }
        public decimal OEE_LessEq_VA { set; get; }
        public decimal OEE_MoreEq_VA { set; get; }
        public decimal OEE_Eq_VA { set; get; }

        public string More_Color { set; get; }
        public string LessEq_Color { set; get; }
        public string MoreEq_Color { set; get; }
        public string Eq_Color { set; get; }
        public string Less_Color { set; get; }

        public System.Drawing.Color ColorMore
        {
            get
            {
                return System.Drawing.ColorTranslator.FromHtml(More_Color);
            }
        }

        public System.Drawing.Color ColorLessEq
        {
            get
            {
                return System.Drawing.ColorTranslator.FromHtml(LessEq_Color);
            }
        }

        public System.Drawing.Color ColorMoreEq
        {
            get
            {
                return System.Drawing.ColorTranslator.FromHtml(MoreEq_Color);
            }
        }

        public System.Drawing.Color ColorEq
        {
            get
            {
                return System.Drawing.ColorTranslator.FromHtml(Eq_Color);
            }
        }

        public System.Drawing.Color ColorLess
        {
            get
            {
                return System.Drawing.ColorTranslator.FromHtml(Less_Color);
            }
        }
    }

    public class WCShiftDataClass
    {
        public WCShiftDataClass()
        {
