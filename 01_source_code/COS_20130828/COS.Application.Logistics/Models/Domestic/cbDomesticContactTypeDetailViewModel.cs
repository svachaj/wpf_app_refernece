...
{
    public partial class cbDomesticContactTypeDetailViewModel : ValidationViewModelBase
    {
        public cbDomesticContactTypeDetailViewModel()
            : base()
        {

        }

        private DomesticContactType _selectedItem = null;
        public DomesticContactType SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.DomesticContactTypes.AddObject(SelectedItem);
                    }
                    else
                    {
