...
{
    public partial class DomesticPriceListDetailViewModel : ValidationViewModelBase
    {
        public DomesticPriceListDetailViewModel()
            : base()
        {

        }

        private DomesticPriceList _selectedItem = null;
        public DomesticPriceList SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.DomesticPriceLists.AddObject(SelectedItem);
                    }
                    else
                    {
