...
{
    public partial class cbDomesticBafPriceDetailViewModel : ValidationViewModelBase
    {
        public cbDomesticBafPriceDetailViewModel()
            : base()
        {

        }

        private DomescticBafPrice _selectedItem = null;
        public DomescticBafPrice SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.DomescticBafPrices.AddObject(SelectedItem);
                    }
                    else
                    {
