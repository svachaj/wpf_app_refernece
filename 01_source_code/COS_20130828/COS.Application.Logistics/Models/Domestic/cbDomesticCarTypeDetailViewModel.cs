...
{
    public partial class cbDomesticCarTypeDetailViewModel : ValidationViewModelBase
    {
        public cbDomesticCarTypeDetailViewModel()
            : base()
        {

        }

        private DomesticCarType _selectedItem = null;
        public DomesticCarType SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.DomesticCarTypes.AddObject(SelectedItem);
                    }
                    else
                    {
