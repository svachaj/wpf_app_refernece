...
{
    public partial class cbDomesticForwarderDetailViewModel : ValidationViewModelBase
    {
        public cbDomesticForwarderDetailViewModel()
            : base()
        {

        }

        private DomesticForwarder _selectedItem = null;
        public DomesticForwarder SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.DomesticForwarders.AddObject(SelectedItem);
                    }
                    else
                    {
        ...
        public string IsValid()
        {
            ...
            {
                err += ResourceHelper.GetResource<string>("m_Body_LOG00000029");
