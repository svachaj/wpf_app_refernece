...
{
    public partial class cbDomesticDriverDetailViewModel : ValidationViewModelBase
    {
        public cbDomesticDriverDetailViewModel()
            : base()
        {

        }

        private DomesticDriver _selectedItem = null;
        public DomesticDriver SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.DomesticDrivers.AddObject(SelectedItem);
                    }
                    else
                    {
