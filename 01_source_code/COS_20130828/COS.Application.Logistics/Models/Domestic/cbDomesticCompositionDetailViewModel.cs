...
{
    public partial class cbDomesticCompositionDetailViewModel : ValidationViewModelBase
    {
        public cbDomesticCompositionDetailViewModel()
            : base()
        {

        }

        private DomesticComposition _selectedItem = null;
        public DomesticComposition SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.DomesticCompositions.AddObject(SelectedItem);
                    }
                    else
                    {
