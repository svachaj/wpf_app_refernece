...
{
    public partial class cbTimeWindowDetailViewModel : ValidationViewModelBase
    {
        public cbTimeWindowDetailViewModel()
            : base()
        {

        }

        private ForeignTimeWindow  _selectedItem = null;
        public ForeignTimeWindow SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.ForeignTimeWindows.AddObject(SelectedItem);
                    }
                    else
                    {
