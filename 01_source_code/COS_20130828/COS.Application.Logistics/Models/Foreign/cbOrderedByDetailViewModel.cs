...
{
    public partial class cbOrderedByDetailViewModel : ValidationViewModelBase
    {
        public cbOrderedByDetailViewModel()
            : base()
        {

        }

        private ForeignOrderedBy _selectedItem = null;
        public ForeignOrderedBy SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.ForeignOrderedBies.AddObject(SelectedItem);
                    }
                    else
                    {
