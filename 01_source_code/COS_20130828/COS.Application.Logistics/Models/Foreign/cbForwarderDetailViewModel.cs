...
{
    public partial class cbForwarderDetailViewModel : ValidationViewModelBase
    {
        public cbForwarderDetailViewModel()
            : base()
        {

        }

        private Forwarder _selectedItem = null;
        public Forwarder SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.Forwarders.AddObject(SelectedItem);
                    }
                    else
                    {
