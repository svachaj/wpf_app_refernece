...
{
    public partial class cbCountryDetailViewModel : ValidationViewModelBase
    {
        public cbCountryDetailViewModel()
            : base()
        {

        }

        private Country _selectedItem = null;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.Countries.AddObject(SelectedItem);
                    }
                    else
                    {
