...
{
    public partial class cbBafPriceDetailViewModel : ValidationViewModelBase
    {
        public cbBafPriceDetailViewModel()
            : base()
        {

        }

        private BafPrice _selectedItem = null;
        public BafPrice SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.BafPrices.AddObject(SelectedItem);
                    }
                    else
                    {
