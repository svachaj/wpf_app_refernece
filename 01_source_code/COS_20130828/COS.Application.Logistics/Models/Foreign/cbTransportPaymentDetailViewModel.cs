...
{
    public partial class cbTransportPaymentDetailViewModel : ValidationViewModelBase
    {
        public cbTransportPaymentDetailViewModel()
            : base()
        {

        }

        private ForeignTransportPayment _selectedItem = null;
        public ForeignTransportPayment SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.ForeignTransportPayments.AddObject(SelectedItem);
                    }
                    else
                    {
