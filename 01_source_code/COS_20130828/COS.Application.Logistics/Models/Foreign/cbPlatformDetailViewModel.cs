...
{
    public partial class cbPlatformDetailViewModel : ValidationViewModelBase
    {
        public cbPlatformDetailViewModel()
            : base()
        {

        }

        private ForeignPlatform _selectedItem = null;
        public ForeignPlatform SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.ForeignPlatforms.AddObject(SelectedItem);
                    }
                    else
                    {
