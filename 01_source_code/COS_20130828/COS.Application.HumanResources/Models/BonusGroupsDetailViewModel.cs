...
{
    public partial class BonusGroupsDetailViewModel : ValidationViewModelBase
    {
        public BonusGroupsDetailViewModel()
            : base()
        {

        }

        private BonusGroup _selectedItem = null;

        public BonusGroup SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.BonusGroups.AddObject(SelectedItem);
                    }
                    else
                    {
        ...
        public string IsValid()
        {
            ...
            {
                err += ResourceHelper.GetResource<string>("m_Body_HR00000001");
