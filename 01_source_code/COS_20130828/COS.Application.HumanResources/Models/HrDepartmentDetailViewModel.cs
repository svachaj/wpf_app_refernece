...
{
    public partial class HrDepartmentDetailViewModel : ValidationViewModelBase
    {
        public HrDepartmentDetailViewModel()
            : base()
        {

        }

        private HrDepartment _selectedItem = null;

        public HrDepartment SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
            ...
            if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
            {
                ...
                {
                    COSContext.Current.HrDepartments.AddObject(SelectedItem);
                }
                else
                {
