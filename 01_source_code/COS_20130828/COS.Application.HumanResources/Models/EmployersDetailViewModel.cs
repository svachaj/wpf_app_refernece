...
{
    public partial class EmployersDetailViewModel : ValidationViewModelBase
    {
        public EmployersDetailViewModel()
            : base()
        {

        }

        private Employer _selectedItem = null;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.Employers.AddObject(SelectedItem);
                    }
                    else
                    {
