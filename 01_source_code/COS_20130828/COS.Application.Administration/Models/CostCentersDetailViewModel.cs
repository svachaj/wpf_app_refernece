...
{
    public partial class CostCentersDetailViewModel : ValidationViewModelBase
    {
        public CostCentersDetailViewModel()
            : base()
        {

        }

        private CostCenter _selectedItem = null;
        public CostCenter SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.CostCenters.AddObject(SelectedItem);
                    }
                    else
                    {
