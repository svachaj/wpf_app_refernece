...
{
    public partial class DivisionDetailViewModel : ValidationViewModelBase
    {
        ...
        private Division _selectedItem = null;
        ...
        public void Save()
        {
                ...
                if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
                {
                    ...
                    {
                        COSContext.Current.Divisions.AddObject(SelectedItem);
                    }
                    else
                    {
