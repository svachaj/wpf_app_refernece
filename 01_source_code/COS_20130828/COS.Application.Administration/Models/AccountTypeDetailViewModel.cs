...
{
    public partial class AccountTypeDetailViewModel : ValidationViewModelBase
    {
        ...
        private SysAccountType _selectedItem = null;
        public SysAccountType SelectedItem
        {
            set
            {
                _selectedItem = value;
        ...
        public void Save()
        {
            ...
            if (string.IsNullOrEmpty(Error) && string.IsNullOrEmpty(customErrors))
            {
                ...
                {
                    COSContext.Current.SysAccountTypes.AddObject(SelectedItem);
                }
                else
                {
